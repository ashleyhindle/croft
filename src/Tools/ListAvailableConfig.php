...
class ListAvailableConfig extends AbstractTool
{
    public function __construct()
    {
        // Setup annotations according to MCP specification
        $this->setTitle('List Available Config Variables')
    ...
    {
        return 'list_available_config_variables';
    }

    public function getDescription(): string
    {
        return 'List all available config variables (from config/*.php) in dot notation';
    }
